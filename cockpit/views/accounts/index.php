    ...
    <table class="uk-table uk-table-tabbed uk-table-striped uk-margin-top" if="{ ready && !loading && accounts.length }">
        <thead>
            <tr>
                ...
                <th class="uk-text-small" width="100">
                    @lang('Social')
                </th>
                @endif
                <th width="20"></th>
        ...
        <tbody>
            <tr each="{account, $index in accounts}">
                ...
                <td><span class="{ account.group=='admin' ? 'uk-badge uk-badge-warning' : 'uk-badge' }">{ account.group }</span></td>
                ...
                @if($app->retrieve('config/social/enabled'))
                <td>
                    <img src="@base('sociallogin:assets/icon/google.svg')" width="25" height="25" alt="Google" if="{account.google}">
                    <img src="@base('sociallogin:assets/icon/facebook.svg')" width="25" height="25" alt="Facebook" if="{account.facebook}">
                </td>
                @endif
                <td>
