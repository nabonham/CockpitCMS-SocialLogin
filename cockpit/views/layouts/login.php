    ...
    <div class="uk-position-relative login-container uk-animation-scale uk-container-vertical-center" role="main" riot-view>
        ...
        <form class="uk-form" method="post" action="@route('/auth/check')" onsubmit="{ submit }">
            ...
            <div id="login-dialog" class="login-dialog uk-panel-box uk-panel-space uk-nbfc" show="{!$user}">
                ...
                <div class="uk-margin-top uk-text-small uk-text-bold uk-text-upper uk-text-center">
                    @lang('or continue with')
                </div>
                <div class="uk-margin-top uk-width-1-1 uk-button-group" uk-grid>
                    <a href="@route('/auth/social/authorize?provider=google')" class="uk-button uk-button-large uk-width-1-2"><img src="@base('sociallogin:assets/icon/google.svg')" width="20" height="20" alt="Google" class="uk-margin-small-right" uk-img><span class="uk-margin-small-left">@lang('Google')</span></a>
                    <a href="@route('/auth/social/authorize?provider=facebook')" class="uk-button uk-button-large uk-width-1-2"><img src="@base('sociallogin:assets/icon/facebook.svg')" width="20" height="20" alt="Facebook" class="uk-margin-small-right" uk-img><span class="uk-margin-small-left">@lang('Facebook')</span></a>
                </div>
                @endif
            </div>
